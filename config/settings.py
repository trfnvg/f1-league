...
# Telegram integration is currently paused.  The worker is no longer started
# by the application; keep this flag false by default for any manual command.
TELEGRAM_WORKER_ENABLED = os.getenv("TELEGRAM_WORKER_ENABLED", "False").lower() == "true"
